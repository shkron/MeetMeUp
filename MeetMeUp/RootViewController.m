...
- (void)viewDidLoad {
    ...
    [self dataWithURLString:kStartingPoint];
...
-(BOOL)textFieldShouldReturn:(UITextField *)textField
{
    ...
    {
        NSString *searchString = [NSString stringWithFormat:@"https://api.meetup.com/2/open_events.json?zip=94103&text=%@&time=,1w&key=3c7f626d333e3a7433a44552f6b775f", self.searchTextField.text];
